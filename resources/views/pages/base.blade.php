...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">    <style>
        ...
        nav {
            ...
            padding: 10px;
            background-color: rgb(114, 93, 116);
        }
        ...
        li {
            ...
            color: white;
            text-align: center;
            background-color: rgb(22, 164, 220);
            border-radius: 9px;

         }

         li:hover {
            background-color: rgba(125, 237, 33, 0.757);
            border-radius: 9px;
         }
    </style>
</head>
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li class="nav-item">
                <a class="nav-link {{Route::is('courses') ? 'active' : ''}}" href="{{url('/courses')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-text" viewBox="0 0 16 16">
